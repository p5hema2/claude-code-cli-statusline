...
/**
 * Git branch widget colors for different states
 */
export interface GitBranchColors {
  /** Color when working tree is clean */
  clean?: ColorValue;
  /** Color when there are uncommitted changes */
  dirty?: ColorValue;
  /** Color when ahead of remote */
  ahead?: ColorValue;
  /** Color when behind remote */
  behind?: ColorValue;
  /** Color when in detached HEAD state */
  detached?: ColorValue;
}
